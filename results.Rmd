...
g3 <- ggplot(drvgr2019_B, aes(drvgr2019_B$GBA4RTT)) + geom_histogram(col=I("black"), bins = 20) + xlab("Graduation rate - Bachelor degree within 4 years, total
")
g3 + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())
